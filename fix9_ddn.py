...
def main():
   ...
   while True :
       ...
       tmp_jadwal_pengiriman = dt.datetime.strptime(jadwal_pengiriman, '%d-%m-%y %H:%M:%S')
       ...
       if (str(current_time) == jadwal_pengiriman or (elapsed.minute < 2 and flag_data_kirim == 1 and elapsed.hour == 0)):
           flag_data_kirim = 0
           if (flag_kirim == 0):
               flag_kirim = 1
